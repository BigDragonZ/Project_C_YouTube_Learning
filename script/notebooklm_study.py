...
Y2N_OUTPUT = PROJECT_ROOT / "output"
...
def _save_file(course: str, filename: str, content: str) -> Path:
    """Save content to output/course/filename."""
    out_dir = Y2N_OUTPUT / course
...
def parse_syllabus(course: str) -> list[dict]:
    ...
    syllabus_file = Y2N_OUTPUT / course / f"{course}_课程大纲.md"
...
def main() -> int:
    ...
    print(f"Output: {Y2N_OUTPUT / args.course}")
    print(f"{'='*60}")
    return 0
